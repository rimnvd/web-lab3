package se.s313305.repository.manager;
...
public class PersistenceFactory implements Serializable {
    ...
    public void init() {
        ...
        result.put("javax.persistence.jdbc.user", System.getenv("LOGIN"));
        result.put("javax.persistence.jdbc.password", System.getenv("PASSWORD"));
        try {
